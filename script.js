// bg will be of light theme first
// a default profile should be visible at the starting
// no search result and cross will be hidden initially
// so we will call a fuction to do this (init func)
// it will bw called on reloading
...
function init() {
  ...
  //by default, my info will be shown
  getUserData(url + "djoshi72");
}
